<%@ Page Language="C#" MasterPageFile="~/_Admin/MasterPage.master" AutoEventWireup="true" CodeFile="registro.aspx.cs" Inherits="loja._Admin_produto_cores_registro" %>
...
<asp:Content ID="migalha" runat="server" ContentPlaceHolderID="migalha">
    <ul class="breadcrumb">
        ...
        <li>
            <a href="listagem.aspx"><%=Migalha.Cores%></a>
            <span class="divider">
                <i class="icon-angle-right"></i>
            </span>
        </li>
