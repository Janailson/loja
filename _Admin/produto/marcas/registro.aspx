<%@ Page Language="C#" MasterPageFile="~/_Admin/MasterPage.master" AutoEventWireup="true" CodeFile="registro.aspx.cs" Inherits="loja._Admin_produto_marcas_registro" %>
...
<asp:Content ID="migalha" runat="server" ContentPlaceHolderID="migalha">
    <ul class="breadcrumb">
        ...
        <li>
            <a href="listagem.aspx"><%=Migalha.Marcas%></a>
            <span class="divider">
                <i class="icon-angle-right"></i>
            </span>
        </li>
...
<asp:Content ID="conteudo" runat="server" ContentPlaceHolderID="conteudo">
    ...
    <div class="row-fluid form-horizontal">
        ...
        <asp:Panel ID="pnlLogo" runat="server" CssClass="control-group">
            <label class="control-label"><%=Idioma.Logo%> : *</label>
            <div class="controls">
                <span class="input-icon input-icon-right span4">
                    <asp:FileUpload ID="uplLogo" runat="server" CssClass="input-file tooltip-error span12" />
                    <% if (lblLogo.Visible) { %><i class="icon-remove-sign"></i><% } %>
                </span>
