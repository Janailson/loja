<%@ Page Language="C#" MasterPageFile="~/_Admin/MasterPage.master" AutoEventWireup="true" CodeFile="listagem.aspx.cs" Inherits="loja._Admin_produto_marcas_listagem" %>
...
<asp:Content ID="migalha" runat="server" ContentPlaceHolderID="migalha">
    <ul class="breadcrumb">
        ...
        <li class="active"><%=Migalha.Marcas%></li>
    </ul><!--.breadcrumb-->
</asp:Content>
                    ...
                    <asp:Repeater ID="rptListagem" runat="server">
                        <ItemTemplate>
                            <tr>
                                <td class="center">
                                    <label>
                                        <input type="checkbox" name="chkExcluir" value="<%# Eval("IDMarca") %>" />
                                        <span class="lbl"></span>
                                    </label>
                                </td>
                                <td>
                                    <a href="registro.aspx?id=<%# Eval("IDMarca") %>"><%# Eval("Nome") %></a>
                                </td>
                                <td class="hidden-480">
                                    <%# Status(Eval("Status")) %>
                                </td>
                                <td class="td-actions">
                                    <div class="hidden-phone visible-desktop btn-group">
										<button class="btn btn-mini btn-info" onclick="window.location='registro.aspx?id=<%# Eval("IDMarca") %>'; return false;" title="Editar">
