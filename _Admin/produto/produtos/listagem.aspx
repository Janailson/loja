<%@ Page Language="C#" MasterPageFile="~/_Admin/MasterPage.master" AutoEventWireup="true" CodeFile="listagem.aspx.cs" Inherits="loja._Admin_produto_produtos_listagem" %>

<asp:Content ID="migalha" runat="server" ContentPlaceHolderID="migalha">
    <ul class="breadcrumb">
        <li>
            <i class="icon-dashboard"></i>
            <a id="A1" href="~/_Admin/" runat="server"><%=Migalha.Dashboard%></a>
            <span class="divider">
                <i class="icon-angle-right"></i>
            </span>
        </li>
        <li class="active"><%=Migalha.Produtos%></li>
    </ul><!--.breadcrumb-->
</asp:Content>
                    ...
                    <asp:Repeater ID="rptListagem" runat="server">
                        <ItemTemplate>
                            <tr>
                                <td class="center">
                                    <label>
                                        <input type="checkbox" name="chkExcluir" value="<%# Eval("IDProduto") %>" />
                                        <span class="lbl"></span>
                                    </label>
                                </td>
                                <td>
                                    <a href="registro.aspx?id=<%# Eval("IDProduto") %>"><%# Eval("Nome") %></a>
                                </td>
                                <td class="hidden-480">
                                    <%# Status(Eval("Status")) %>
                                </td>
                                <td class="td-actions">
                                    <div class="hidden-phone visible-desktop btn-group">
										<button class="btn btn-mini btn-info" onclick="window.location='registro.aspx?id=<%# Eval("IDProduto") %>'; return false;" title="Editar">
