<%@ Page Language="C#" MasterPageFile="~/_Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="loja._Admin_Default" %>
...
<asp:Content ID="conteudo" runat="server" ContentPlaceHolderID="conteudo">
    ...
    <div class="row-fluid">
        ...
        <div class="alert alert-block alert-success">
            ...
            Welcome to
            <strong class="green">Ace <small>(v1.1)</small></strong>, the lightweight, feature-rich, easy to use and well-documented admin template.
        </div>
...
<asp:Content ID="script" runat="server" ContentPlaceHolderID="script">
    ...
    <script src="<%=ConfigurationManager.AppSettings["Url"]%>/_Admin/assets/js/jquery-ui-1.10.3.custom.min.js"></script>
    <script src="<%=ConfigurationManager.AppSettings["Url"]%>/_Admin/assets/js/jquery.ui.touch-punch.min.js"></script>
    <script src="<%=ConfigurationManager.AppSettings["Url"]%>/_Admin/assets/js/jquery.slimscroll.min.js"></script>
    <script src="<%=ConfigurationManager.AppSettings["Url"]%>/_Admin/assets/js/jquery.easy-pie-chart.min.js"></script>
    <script src="<%=ConfigurationManager.AppSettings["Url"]%>/_Admin/assets/js/jquery.sparkline.min.js"></script>
    <script src="<%=ConfigurationManager.AppSettings["Url"]%>/_Admin/assets/js/flot/jquery.flot.min.js"></script>
    <script src="<%=ConfigurationManager.AppSettings["Url"]%>/_Admin/assets/js/flot/jquery.flot.pie.min.js"></script>
    <script src="<%=ConfigurationManager.AppSettings["Url"]%>/_Admin/assets/js/flot/jquery.flot.resize.min.js"></script>
