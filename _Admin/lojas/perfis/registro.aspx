<%@ Page Language="C#" MasterPageFile="~/_Admin/MasterPage.master" AutoEventWireup="true" CodeFile="registro.aspx.cs" Inherits="loja._Admin_lojas_perfis_registro" %>
...
<asp:Content ID="migalha" runat="server" ContentPlaceHolderID="migalha">
    <ul class="breadcrumb">
        ...
        <li>
            <a href="listagem.aspx?loja=<%=Request["loja"]%>">Perfis</a>
            <span class="divider">
                <i class="icon-angle-right"></i>
            </span>
        </li>
