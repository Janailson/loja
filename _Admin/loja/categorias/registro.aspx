<%@ Page Language="C#" MasterPageFile="~/_Admin/MasterPage.master" AutoEventWireup="true" CodeFile="registro.aspx.cs" Inherits="loja._Admin_loja_categorias_registro" %>
...
<asp:Content ID="migalha" runat="server" ContentPlaceHolderID="migalha">
    <ul class="breadcrumb">
        ...
        <li>
            <a href="listagem.aspx"><%=Migalha.Categorias%></a>
            <span class="divider">
                <i class="icon-angle-right"></i>
            </span>
        </li>
...
<asp:Content ID="conteudo" runat="server" ContentPlaceHolderID="conteudo">
    ...
    <div class="row-fluid form-horizontal">
        ...
        <asp:Panel ID="pnlSite" runat="server" CssClass="control-group">
			<label class="control-label"><%=Idioma.Site%> : *</label>
			<div class="controls">
                <label>
					<input type="checkbox" id="chkSite" runat="server" class="ace-switch ace-switch-3" checked="checked" />
					<span class="lbl"></span>
                </label>
			</div>
		</asp:Panel>
