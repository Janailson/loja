<%@ Control Language="C#" AutoEventWireup="true" CodeFile="categoria_nivel_3.ascx.cs" Inherits="loja.categoria_nivel_3" %>
...
<div id="principal">
	<div class="menu">
        <ul>
            <li class="tl"><a href="categoria.aspx?id=<%=pai.IDCategoria%>"><%=pai.Nome%></a></li>
            <li class="tl2"><a href="categoria.aspx?id=<%=categoria.IDCategoria%>"><%=categoria.Nome%></a></li>
            <li><a href="categoria.aspx?id=<%=subcategoria.IDCategoria%>"><%=subcategoria.Nome%> (<%=subcategoria.Produtos%>)</a></li>
